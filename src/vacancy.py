...
class Vacancy:
    __slots__ = ('name', 'salary', 'link_to_vacancy', 'requirement', 'currency', 'responsibility')

    def __init__(self, name, salary, currency, link_to_vacancy, requirement, responsibility):
        self.name = name
    ...
    def to_dict(self):
        return {'name': self.name, 'salary': self.salary, 'currency': self.currency, 'link_to_vacancy': self.link_to_vacancy,

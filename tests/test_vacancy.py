...
def test_init_vacancy(vacancy_fixture):
    vacancy = Vacancy(
        ...
        "Опыт в роли HR-директора / HRBP от 10 лет, преимущественно в технологических / производственных / международных стартапах. Опыт массового и точечного подбора...",
        "Уровень: Руководитель / HRD. Формирование и реализация HR-стратегии, соответствующей целям стартапа. Подбор ключевой команды: от инженерного до C‑level состава. ",
    )
...
def test_cast_to_object(vacancies_list_dict, vacancies_list, hh_api_answer_fixture):
    vacancies = Vacancy.cast_to_object_list(hh_api_answer_fixture)
    ...
    assert vacancies[0].requirement == ("Глубокие знания всех HR бизнес-процессов, успешный опыт их <highlighttext>разработки</highlighttext> и внедрения. "
                                        "Опыт написания стандартов, инструкций и регламентов ")
    assert vacancies[0].get_responsibility == ("Организация адаптации новых сотрудников. Построение и автоматизация HR процессов. "
